...
import {
    ...
    CalendarHeader,
    CalendarHeading
} from '@/app/components/ui/calendar/index'
import {Select, SelectContent, SelectItem, SelectTrigger, SelectValue,} from '@/app/components/ui/select'
import {cn} from '@/app/lib/utils'
import CalendarPrevButton from "@/app/components/ui/calendar/CalendarPrevButton.vue";
import CalendarNextButton from "@/app/components/ui/calendar/CalendarNextButton.vue";

const props = withDefaults(defineProps<CalendarRootProps & { class?: HTMLAttributes['class'], type?: 'default' | 'advanced' }>(), {
